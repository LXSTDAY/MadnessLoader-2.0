...
const SCRIPT_COMMAND is_widget_pressed                  = { 0x0A51, "i" };

const SCRIPT_COMMAND lock_camera_position               = { 0x0930, "i" };
const SCRIPT_COMMAND lock_camera_targetpoint            = { 0x092F, "i"};
...
const SCRIPT_COMMAND create_racing_checkpoint           = { 0x06d5,	"ifffffffv" };        // type, x, y, z, nx, ny. nz, size, $id (n=next checkpoint) /* 0 = Street Checkpoint with arrow to the next checkpoint 1 and 2 = Street Checkpoint 3 and 4 = Flight Checkpoint (circle) */
